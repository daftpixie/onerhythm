...
from app.api.routes.mission_v3 import router as mission_v3_router
...
# v3 mission-first APIs are the canonical truth layer.
api_router.include_router(mission_v3_router)
# Legacy upload routes retained during migration (PRD v3 §18).

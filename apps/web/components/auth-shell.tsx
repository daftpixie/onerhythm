  ...
  return (
    <main className="page-shell mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-6 py-10 sm:px-10 lg:px-12">
      <header className="page-header">
        ...
        <h1 className="page-title max-w-3xl mt-4">
          {mode === "sign-up"
            ? "Welcome to OneRhythm. Let's start by getting to know your experience."
            : "Welcome back. Your profile, guidance, and controls are here."}
        </h1>
        <p className="page-intro mt-4 max-w-2xl">
          Accounts keep ownership boundaries explicit across self-reported
          profiles, uploads, consent, educational guidance, and export or delete
          requests.
        </p>
      </header>
